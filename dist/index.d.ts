...
export declare type AbstractNodeType = 'start' | 'end' | 'branch' | 'condition' | 'loop' | 'common';
...
export declare type ZoomType = 'out' | 'in';
export declare type HistoryType = 'undo' | 'redo';
