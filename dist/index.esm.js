...
import React, { createContext, useContext, useState, useMemo, useRef, useEffect, forwardRef, useImperativeHandle } from 'react';
...
var useAction = function useAction() {
  ...
  var addNode = function addNode(_node, _newNodeType) {
    ...
    if (getIsConditionNode(registerNodes, newNodeType)) {
      ...
      var parentPath = path;
      var parentNodes = get(nodes, parentPath || []);
...
var useSort = function useSort() {
  ...
  var backward = function backward() {
    ...
    var parentNodes = get(nodes, path);
...
var AddNodeButton = function AddNodeButton(props) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(SplitLine, null), !readonly && options.length > 0 ? droppable ? /*#__PURE__*/React.createElement(DropComponent, {
    onDrop: handleDrop
  }) : PopoverComponent ? /*#__PURE__*/React.createElement(PopoverComponent, {
    visible: visible,
...
var RemoveButton = function RemoveButton() {
  ...
  var registerNode = getRegisterNode(registerNodes, node.type);
  return !readonly && !(registerNode === null || registerNode === void 0 ? void 0 : registerNode.customRemove) && PopconfirmComponent ? /*#__PURE__*/React.createElement(PopconfirmComponent, {
...
var SortingDashed = function SortingDashed() {
  var _useContext2 = useContext(BuilderContext),
...
var BranchNode = function BranchNode(props) {
  ...
  var _useContext3 = useContext(BuilderContext),
  ...
  }, conditionCount === 1 ? /*#__PURE__*/React.createElement(ConditionsDashed, null) : null, children === null || children === void 0 ? void 0 : children.map(function (branch, index) {
    var _node$path;
...
var Builder = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    nodes: nodes
  }))), DrawerComponent ? /*#__PURE__*/React.createElement(DrawerComponent, _objectSpread2({
    ...
    onClose: closeDrawer
  }, drawerProps), ConfigComponent && selectedNode ? /*#__PURE__*/React.createElement(ConfigComponent, {
    key: selectedNode.id,
    node: selectedNode,
    nodes: nodes,
    cancel: closeDrawer,
...
var FlowBuilder = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  var _useState = useState((zoomTool === null || zoomTool === void 0 ? void 0 : zoomTool.initialValue) || 100),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  var _useState13 = useState(props.registerNodes || []),
  ...
  var handleSortEnd = function handleSortEnd(params) {
    ...
    var children = (_get = get(nodes, collection.split(','))) === null || _get === void 0 ? void 0 : _get.children;
...
export { BuilderContext, NodeContext, buildFlatNodes, buildTreeNodes, createUuid, defaultMaxLength, defaultMaxZoom, defaultMinZoom, defaultZoomStep, useAction, useDrawer, useHistory, useSort, useZoom };
